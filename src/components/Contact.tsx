  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_email: 'sanchaniyameet476@gmail.com', // recipient email in the template
      };

      // Make sure EmailJS is initialized (init called in useEffect)
          ...
          <form onSubmit={handleSubmit} className="space-y-6" aria-live="polite">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-card border border-border/50 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/10"
            ...
            {/* Submission feedback */}
            <div aria-atomic="true" className="mt-2">
              {submitStatus === 'success' && (
                <div className="text-sm text-green-600">Message sent successfully. I'll get back to you soon.</div>
              )}
              {submitStatus === 'error' && (
                <div className="text-sm text-red-600">Sorry, something went wrong. Please try again or email me directly at sanchaniyameet476@gmail.com</div>
              )}
            </div>
          </form>
        </div>
